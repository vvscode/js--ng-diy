...
describe('Scope', function() {
  ...
  describe('digest', function() {
    ...
    it('compares based on value if enabled', function() {
      ...
      scope.$digest();
      sinon.log('Scope counter should be 1 ( it is :' + scope.counter + ' )' );
      expect(scope.counter).toBe(1);
    ...
    it('executes $evalAsync\'ed functinos added by watch functions', function() {
      scope.aValue = [1,2,3];
    ...
    it('executed $evalAsync\'ed function even when not dirty', function() {
      scope.aValue = [1,2,3];
  ...
  describe('inheritance', function() {
    ...
    it('digests its childre', function() {
      var parent = new Scope();
      var child = parent.$new();
